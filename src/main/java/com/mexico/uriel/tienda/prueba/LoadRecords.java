...
public class LoadRecords
{
	...
	public static void cargarRegistros() throws FileNotFoundException
	{
		...
		{
			pedidoList.get(i).agregarItems(new ItemsPedido(i+1,productoDao.ConsultaPorId((Integer) (i+1)),pedidoList.get(i)));
	...
	private static void loadProducto
	(String type, ProductoDao productoDao,CategoriaDao categoriaDao, EntityManager em) 
	...
	private static void loadCategoria
	(String type, CategoriaDao categoriaDao,EntityManager em) throws FileNotFoundException
	{
	...
	private static void loadCliente(String type, ClienteDao clienteDao,EntityManager em)
	throws FileNotFoundException
	{
	...
	{
		File file = new File("C:\\Users\\Altair\\Documents\\Alura\\JAVA\\tienda\\src\\main\\resources\\META-INF\\Utils\\"+type+".txt");
